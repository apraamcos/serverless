...
module.exports = {
  mergeIamTemplates() {
    ...
    const tags = this.serverless.service.provider.tags ? 
     Object.entries(this.serverless.service.provider.tags).map(x=> {
        return {
          Key: x[0],
          Value: x[1]
        }
    ...
    // set role tags
    iamRoleLambdaExecutionTemplate.Properties.Tags = tags;
